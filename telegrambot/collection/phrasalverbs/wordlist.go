...
var VocabularyVerbs = schema.NewVocabulary(
	map[schema.Term][]schema.Translation{
		...
		"cut out":                            {"вырезать"},
		"depend on something":                {"зависеть от чего-то"},
		...
		"put out":                            {"тушить"},
		"put somebody off (doing something)": {"причина, чтобы что-то не делать"},
